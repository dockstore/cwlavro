...
public class SubworkflowFeatureRequirement extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<SubworkflowFeatureRequirement> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SubworkflowFeatureRequirement> getDecoder() {
    return DECODER;
  }
  ...
  /**
   * Serializes this SubworkflowFeatureRequirement to a ByteBuffer.
  ...
  /**
   * Deserializes a SubworkflowFeatureRequirement from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SubworkflowFeatureRequirement instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SubworkflowFeatureRequirement fromByteBuffer(
   ...
   */
  public static io.cwl.avro.SubworkflowFeatureRequirement.Builder newBuilder() {
    return new io.cwl.avro.SubworkflowFeatureRequirement.Builder();
  }
   ...
   * @return A new SubworkflowFeatureRequirement RecordBuilder
   */
  public static io.cwl.avro.SubworkflowFeatureRequirement.Builder newBuilder(io.cwl.avro.SubworkflowFeatureRequirement.Builder other) {
    if (other == null) {
      return new io.cwl.avro.SubworkflowFeatureRequirement.Builder();
    } else {
      return new io.cwl.avro.SubworkflowFeatureRequirement.Builder(other);
    }
  }
   ...
   * @return A new SubworkflowFeatureRequirement RecordBuilder
   */
  public static io.cwl.avro.SubworkflowFeatureRequirement.Builder newBuilder(io.cwl.avro.SubworkflowFeatureRequirement other) {
    if (other == null) {
      return new io.cwl.avro.SubworkflowFeatureRequirement.Builder();
    } else {
      return new io.cwl.avro.SubworkflowFeatureRequirement.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SubworkflowFeatureRequirement>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.SubworkflowFeatureRequirement.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.SubworkflowFeatureRequirement.Builder setClass$(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.SubworkflowFeatureRequirement.Builder clearClass$() {
      class$ = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SubworkflowFeatureRequirement>
    WRITER$ = (org.apache.avro.io.DatumWriter<SubworkflowFeatureRequirement>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SubworkflowFeatureRequirement>
    READER$ = (org.apache.avro.io.DatumReader<SubworkflowFeatureRequirement>)MODEL$.createDatumReader(SCHEMA$);
