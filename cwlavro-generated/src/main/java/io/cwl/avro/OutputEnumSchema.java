...
public class OutputEnumSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<OutputEnumSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OutputEnumSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<OutputEnumSchema>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this OutputEnumSchema to a ByteBuffer.
  ...
  /**
   * Deserializes a OutputEnumSchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a OutputEnumSchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static OutputEnumSchema fromByteBuffer(
   ...
   */
  public OutputEnumSchema(java.util.List<java.lang.CharSequence> symbols, io.cwl.avro.EnumSchemaPackage.type.Enum_symbol type, java.lang.CharSequence label, io.cwl.avro.CommandOutputBinding outputBinding) {
   ...
   */
  public static io.cwl.avro.OutputEnumSchema.Builder newBuilder() {
    return new io.cwl.avro.OutputEnumSchema.Builder();
  }
   ...
   * @return A new OutputEnumSchema RecordBuilder
   */
  public static io.cwl.avro.OutputEnumSchema.Builder newBuilder(io.cwl.avro.OutputEnumSchema.Builder other) {
    if (other == null) {
      return new io.cwl.avro.OutputEnumSchema.Builder();
    } else {
      return new io.cwl.avro.OutputEnumSchema.Builder(other);
    }
  }
   ...
   * @return A new OutputEnumSchema RecordBuilder
   */
  public static io.cwl.avro.OutputEnumSchema.Builder newBuilder(io.cwl.avro.OutputEnumSchema other) {
    if (other == null) {
      return new io.cwl.avro.OutputEnumSchema.Builder();
    } else {
      return new io.cwl.avro.OutputEnumSchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OutputEnumSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.OutputEnumSchema.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.OutputEnumSchema other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.symbols)) {
        this.symbols = data().deepCopy(fields()[0].schema(), other.symbols);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder setSymbols(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder clearSymbols() {
      symbols = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder setType(io.cwl.avro.EnumSchemaPackage.type.Enum_symbol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder setOutputBinding(io.cwl.avro.CommandOutputBinding value) {
    ...
    public io.cwl.avro.OutputEnumSchema.Builder setOutputBindingBuilder(io.cwl.avro.CommandOutputBinding.Builder value) {
      clearOutputBinding();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputEnumSchema.Builder clearOutputBinding() {
      outputBinding = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<OutputEnumSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<OutputEnumSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<OutputEnumSchema>
    READER$ = (org.apache.avro.io.DatumReader<OutputEnumSchema>)MODEL$.createDatumReader(SCHEMA$);
