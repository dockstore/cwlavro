...
public class OutputRecordField extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<OutputRecordField> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<OutputRecordField> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<OutputRecordField>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this OutputRecordField to a ByteBuffer.
  ...
  /**
   * Deserializes a OutputRecordField from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a OutputRecordField instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static OutputRecordField fromByteBuffer(
 ...
 */
   ...
   */
  public OutputRecordField(java.lang.CharSequence name, java.lang.CharSequence doc, java.lang.Object type, io.cwl.avro.CommandOutputBinding outputBinding) {
    this.name = name;
    this.doc = doc;
    this.type = type;
   ...
   * @return A new OutputRecordField RecordBuilder
   */
  public static io.cwl.avro.OutputRecordField.Builder newBuilder() {
    return new io.cwl.avro.OutputRecordField.Builder();
  }
   ...
   * @return A new OutputRecordField RecordBuilder
   */
  public static io.cwl.avro.OutputRecordField.Builder newBuilder(io.cwl.avro.OutputRecordField.Builder other) {
    if (other == null) {
      return new io.cwl.avro.OutputRecordField.Builder();
    } else {
      return new io.cwl.avro.OutputRecordField.Builder(other);
    }
  }
   ...
   * @return A new OutputRecordField RecordBuilder
   */
  public static io.cwl.avro.OutputRecordField.Builder newBuilder(io.cwl.avro.OutputRecordField other) {
    if (other == null) {
      return new io.cwl.avro.OutputRecordField.Builder();
    } else {
      return new io.cwl.avro.OutputRecordField.Builder(other);
 ...
 */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.OutputRecordField.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.OutputRecordField other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder setDoc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder clearDoc() {
      doc = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder setType(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder setOutputBinding(io.cwl.avro.CommandOutputBinding value) {
    ...
    public io.cwl.avro.OutputRecordField.Builder setOutputBindingBuilder(io.cwl.avro.CommandOutputBinding.Builder value) {
      clearOutputBinding();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.OutputRecordField.Builder clearOutputBinding() {
      outputBinding = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<OutputRecordField>
    WRITER$ = (org.apache.avro.io.DatumWriter<OutputRecordField>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<OutputRecordField>
    READER$ = (org.apache.avro.io.DatumReader<OutputRecordField>)MODEL$.createDatumReader(SCHEMA$);
