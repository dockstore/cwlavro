...
used to generate and/or validate the output object.
 */
  @Deprecated public java.util.List<ExpressionToolOutputParameter> outputs;
...
matches the output parameters of the ExpressionTool.
   ...
   */
  public ExpressionTool(java.lang.CharSequence id, java.util.List<InputParameter> inputs, java.util.List<ExpressionToolOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Object> hints, java.lang.CharSequence label, java.lang.CharSequence doc, CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object expression) {
    this.id = id;
    this.inputs = inputs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: outputs = (java.util.List<ExpressionToolOutputParameter>)value$; break;
...
used to generate and/or validate the output object.
   ...
   */
  public java.util.List<ExpressionToolOutputParameter> getOutputs() {
    return outputs;
  }
...
used to generate and/or validate the output object.
   ...
   * @param value the value to set.
   */
  public void setOutputs(java.util.List<ExpressionToolOutputParameter> value) {
    this.outputs = value;
  }
...
used to generate and/or validate the output object.
 */
    private java.util.List<ExpressionToolOutputParameter> outputs;
    /** Declares requirements that apply to either the runtime environment or the
workflow engine that must be met in order to execute this process.  If
an implementation cannot satisfy all requirements, or a requirement is
listed which is not recognized by the implementation, it is a fatal
...
used to generate and/or validate the output object.
      ...
      * @return This builder.
      */
    public ExpressionTool.Builder setOutputs(java.util.List<ExpressionToolOutputParameter> value) {
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public ExpressionTool.Builder setHints(java.util.List<Object> value) {
...
the implementation may report a warning.
    ...
    /**
      ...
      * @return This builder.
      */
    public ExpressionTool.Builder setDoc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ExpressionTool.Builder clearDoc() {
      doc = null;
...
required for a Process embedded inside another Process.
      ...
      * @return This builder.
      */
    public ExpressionTool.Builder setCwlVersion(CWLVersion value) {
...
matches the output parameters of the ExpressionTool.
    ...
    public ExpressionTool build() {
      try {
        ...
        record.outputs = fieldSetFlags()[2] ? this.outputs : (java.util.List<ExpressionToolOutputParameter>) defaultValue(fields()[2]);
