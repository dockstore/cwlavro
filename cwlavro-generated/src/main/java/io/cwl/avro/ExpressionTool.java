...
public class ExpressionTool extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<ExpressionTool> ENCODER =
      new BinaryMessageEncoder<ExpressionTool>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ExpressionTool> DECODER =
      new BinaryMessageDecoder<ExpressionTool>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<ExpressionTool> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ExpressionTool>(MODEL$, SCHEMA$, resolver);
  }
...
matches the output parameters of the ExpressionTool.
   ...
   */
  public ExpressionTool(java.lang.CharSequence id, java.util.List<io.cwl.avro.InputParameter> inputs, java.util.List<io.cwl.avro.ExpressionToolOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Object> hints, java.lang.CharSequence label, java.lang.CharSequence doc, io.cwl.avro.CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object expression) {
    this.id = id;
    this.inputs = inputs;
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionTool.Builder setHints(java.util.List<Object> value) {
