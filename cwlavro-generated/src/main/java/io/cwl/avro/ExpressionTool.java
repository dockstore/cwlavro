...
matches the output parameters of the ExpressionTool.
   ...
   */
  public ExpressionTool(java.lang.CharSequence id, java.util.List<InputParameter> inputs, java.util.List<ExpressionToolOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Any> hints, java.lang.CharSequence label, java.lang.CharSequence doc, CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object expression) {
    this.id = id;
    this.inputs = inputs;
