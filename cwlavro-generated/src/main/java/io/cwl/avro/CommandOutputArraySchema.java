...
public class CommandOutputArraySchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<CommandOutputArraySchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CommandOutputArraySchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandOutputArraySchema>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CommandOutputArraySchema to a ByteBuffer.
  ...
  /**
   * Deserializes a CommandOutputArraySchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CommandOutputArraySchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CommandOutputArraySchema fromByteBuffer(
   ...
   */
  public CommandOutputArraySchema(java.lang.Object items, io.cwl.avro.ArraySchemaPackage.type.Array_symbol type, java.lang.CharSequence label, io.cwl.avro.CommandOutputBinding outputBinding) {
    this.items = items;
    this.type = type;
    this.label = label;
   ...
   * @return A new CommandOutputArraySchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputArraySchema.Builder newBuilder() {
    return new io.cwl.avro.CommandOutputArraySchema.Builder();
  }
   ...
   * @return A new CommandOutputArraySchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputArraySchema.Builder newBuilder(io.cwl.avro.CommandOutputArraySchema.Builder other) {
    if (other == null) {
      return new io.cwl.avro.CommandOutputArraySchema.Builder();
    } else {
      return new io.cwl.avro.CommandOutputArraySchema.Builder(other);
    }
  }
   ...
   * @return A new CommandOutputArraySchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputArraySchema.Builder newBuilder(io.cwl.avro.CommandOutputArraySchema other) {
    if (other == null) {
      return new io.cwl.avro.CommandOutputArraySchema.Builder();
    } else {
      return new io.cwl.avro.CommandOutputArraySchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandOutputArraySchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.CommandOutputArraySchema.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.CommandOutputArraySchema other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.items)) {
        this.items = data().deepCopy(fields()[0].schema(), other.items);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder setItems(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder clearItems() {
      items = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder setType(io.cwl.avro.ArraySchemaPackage.type.Array_symbol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder setOutputBinding(io.cwl.avro.CommandOutputBinding value) {
    ...
    public io.cwl.avro.CommandOutputArraySchema.Builder setOutputBindingBuilder(io.cwl.avro.CommandOutputBinding.Builder value) {
      clearOutputBinding();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputArraySchema.Builder clearOutputBinding() {
      outputBinding = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CommandOutputArraySchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<CommandOutputArraySchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CommandOutputArraySchema>
    READER$ = (org.apache.avro.io.DatumReader<CommandOutputArraySchema>)MODEL$.createDatumReader(SCHEMA$);
