 ...
 */
   ...
   * The common name of the software to be configured.   * @param value the value to set.
   */
   ...
   * The (optional) version of the software to configured.   * @param value the value to set.
   */
