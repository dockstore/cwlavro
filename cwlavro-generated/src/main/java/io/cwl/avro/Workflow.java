...
public class Workflow extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static BinaryMessageDecoder<Workflow> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Workflow>(MODEL$, SCHEMA$, resolver);
  }
...
concurrently, provided that dependencies between steps are met.
   ...
   */
  public Workflow(java.lang.CharSequence id, java.util.List<io.cwl.avro.InputParameter> inputs, java.util.List<io.cwl.avro.WorkflowOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Object> hints, java.lang.CharSequence label, java.lang.CharSequence doc, io.cwl.avro.CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object steps) {
    this.id = id;
    this.inputs = inputs;
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setHints(java.util.List<Object> value) {
