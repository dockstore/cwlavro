...
concurrently, provided that dependencies between steps are met.
   ...
   */
  public Workflow(java.lang.CharSequence id, java.util.List<InputParameter> inputs, java.util.List<WorkflowOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Any> hints, java.lang.CharSequence label, java.lang.CharSequence doc, CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object steps) {
    this.id = id;
    this.inputs = inputs;
