...
public class Workflow extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<Workflow> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Workflow> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Workflow> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this Workflow to a ByteBuffer.
  ...
  /**
   * Deserializes a Workflow from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a Workflow instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static Workflow fromByteBuffer(
...
used to generate and/or validate the output object.
 */
  private java.util.List<io.cwl.avro.WorkflowOutputParameter> outputs;
...
concurrently, provided that dependencies between steps are met.
   ...
   */
  public Workflow(java.lang.CharSequence id, java.util.List<io.cwl.avro.InputParameter> inputs, java.util.List<io.cwl.avro.WorkflowOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<io.cwl.avro.FunkyObject> hints, java.lang.CharSequence label, java.lang.CharSequence doc, io.cwl.avro.CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object steps) {
    this.id = id;
    this.inputs = inputs;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: outputs = (java.util.List<io.cwl.avro.WorkflowOutputParameter>)value$; break;
...
used to generate and/or validate the output object.
   ...
   */
  public java.util.List<io.cwl.avro.WorkflowOutputParameter> getOutputs() {
    return outputs;
  }
...
used to generate and/or validate the output object.
   ...
   * @param value the value to set.
   */
  public void setOutputs(java.util.List<io.cwl.avro.WorkflowOutputParameter> value) {
    this.outputs = value;
  }
...
concurrently, provided that dependencies between steps are met.
   ...
   */
  public static io.cwl.avro.Workflow.Builder newBuilder() {
    return new io.cwl.avro.Workflow.Builder();
  }
   ...
   * @return A new Workflow RecordBuilder
   */
  public static io.cwl.avro.Workflow.Builder newBuilder(io.cwl.avro.Workflow.Builder other) {
    if (other == null) {
      return new io.cwl.avro.Workflow.Builder();
    } else {
      return new io.cwl.avro.Workflow.Builder(other);
    }
  }
   ...
   * @return A new Workflow RecordBuilder
   */
  public static io.cwl.avro.Workflow.Builder newBuilder(io.cwl.avro.Workflow other) {
    if (other == null) {
      return new io.cwl.avro.Workflow.Builder();
    } else {
      return new io.cwl.avro.Workflow.Builder(other);
 ...
 */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.Workflow.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.Workflow other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearId() {
      id = null;
...
of expressions.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setInputs(java.util.List<io.cwl.avro.InputParameter> value) {
...
of expressions.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearInputs() {
      inputs = null;
...
used to generate and/or validate the output object.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setOutputs(java.util.List<io.cwl.avro.WorkflowOutputParameter> value) {
...
used to generate and/or validate the output object.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearOutputs() {
      outputs = null;
...
unless overridden at user option.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setRequirements(java.util.List<java.lang.Object> value) {
...
unless overridden at user option.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearRequirements() {
      requirements = null;
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setHints(java.util.List<io.cwl.avro.FunkyObject> value) {
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearHints() {
      hints = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setDoc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearDoc() {
      doc = null;
...
required for a Process embedded inside another Process.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setCwlVersion(io.cwl.avro.CWLVersion value) {
...
required for a Process embedded inside another Process.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearCwlVersion() {
      cwlVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setClass$(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearClass$() {
      class$ = null;
...
concurrently, provided that dependencies between steps are met.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder setSteps(java.lang.Object value) {
...
concurrently, provided that dependencies between steps are met.
      ...
      * @return This builder.
      */
    public io.cwl.avro.Workflow.Builder clearSteps() {
      steps = null;
    ...
    public Workflow build() {
      try {
        ...
        record.outputs = fieldSetFlags()[2] ? this.outputs : (java.util.List<io.cwl.avro.WorkflowOutputParameter>) defaultValue(fields()[2]);
        ...
        record.steps = fieldSetFlags()[9] ? this.steps :  defaultValue(fields()[9]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Workflow>
    WRITER$ = (org.apache.avro.io.DatumWriter<Workflow>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Workflow>
    READER$ = (org.apache.avro.io.DatumReader<Workflow>)MODEL$.createDatumReader(SCHEMA$);
