...
required for a Process embedded inside another Process.
   ...
   * @param steps The individual steps that make up the workflow.  Each step is executed when all of its
input data links are fufilled.  An implementation may choose to execute
the steps in a different order than listed and/or execute steps
concurrently, provided that dependencies between steps are met.

   */
  public Workflow(java.lang.CharSequence id, java.util.List<InputParameter> inputs, java.util.List<WorkflowOutputParameter> outputs, java.util.List<java.lang.Object> requirements, java.util.List<Object> hints, java.lang.CharSequence label, java.lang.CharSequence doc, CWLVersion cwlVersion, java.lang.CharSequence class$, java.lang.Object steps) {
    this.id = id;
    this.inputs = inputs;
...
required for a Process embedded inside another Process.
   ...
   * @return The individual steps that make up the workflow.  Each step is executed when all of its
input data links are fufilled.  An implementation may choose to execute
the steps in a different order than listed and/or execute steps
concurrently, provided that dependencies between steps are met.
...
concurrently, provided that dependencies between steps are met.
   ...
   * @return A new Workflow RecordBuilder
   */
...
the implementation may report a warning.
      ...
      * @return This builder.
      */
    public Workflow.Builder setHints(java.util.List<Object> value) {
...
the implementation may report a warning.
    ...
    /**
      ...
      * @return This builder.
      */
    public Workflow.Builder setDoc(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Workflow.Builder clearDoc() {
      doc = null;
...
required for a Process embedded inside another Process.
      ...
      * @return This builder.
      */
    public Workflow.Builder setCwlVersion(CWLVersion value) {
