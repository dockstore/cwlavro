...
public class CommandOutputEnumSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<CommandOutputEnumSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CommandOutputEnumSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandOutputEnumSchema>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CommandOutputEnumSchema to a ByteBuffer.
  ...
  /**
   * Deserializes a CommandOutputEnumSchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CommandOutputEnumSchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CommandOutputEnumSchema fromByteBuffer(
   ...
   */
  public CommandOutputEnumSchema(java.util.List<java.lang.CharSequence> symbols, io.cwl.avro.EnumSchemaPackage.type.Enum_symbol type, java.lang.CharSequence label, io.cwl.avro.CommandOutputBinding outputBinding) {
   ...
   * @return A new CommandOutputEnumSchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputEnumSchema.Builder newBuilder() {
    return new io.cwl.avro.CommandOutputEnumSchema.Builder();
  }
   ...
   * @return A new CommandOutputEnumSchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputEnumSchema.Builder newBuilder(io.cwl.avro.CommandOutputEnumSchema.Builder other) {
    if (other == null) {
      return new io.cwl.avro.CommandOutputEnumSchema.Builder();
    } else {
      return new io.cwl.avro.CommandOutputEnumSchema.Builder(other);
    }
  }
   ...
   * @return A new CommandOutputEnumSchema RecordBuilder
   */
  public static io.cwl.avro.CommandOutputEnumSchema.Builder newBuilder(io.cwl.avro.CommandOutputEnumSchema other) {
    if (other == null) {
      return new io.cwl.avro.CommandOutputEnumSchema.Builder();
    } else {
      return new io.cwl.avro.CommandOutputEnumSchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandOutputEnumSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.CommandOutputEnumSchema.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.CommandOutputEnumSchema other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.symbols)) {
        this.symbols = data().deepCopy(fields()[0].schema(), other.symbols);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder setSymbols(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder clearSymbols() {
      symbols = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder setType(io.cwl.avro.EnumSchemaPackage.type.Enum_symbol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder setOutputBinding(io.cwl.avro.CommandOutputBinding value) {
    ...
    public io.cwl.avro.CommandOutputEnumSchema.Builder setOutputBindingBuilder(io.cwl.avro.CommandOutputBinding.Builder value) {
      clearOutputBinding();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandOutputEnumSchema.Builder clearOutputBinding() {
      outputBinding = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CommandOutputEnumSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<CommandOutputEnumSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CommandOutputEnumSchema>
    READER$ = (org.apache.avro.io.DatumReader<CommandOutputEnumSchema>)MODEL$.createDatumReader(SCHEMA$);
