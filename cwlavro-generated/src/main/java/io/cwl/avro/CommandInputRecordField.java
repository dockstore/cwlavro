...
public class CommandInputRecordField extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CommandInputRecordField> ENCODER =
      new BinaryMessageEncoder<CommandInputRecordField>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CommandInputRecordField> DECODER =
      new BinaryMessageDecoder<CommandInputRecordField>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<CommandInputRecordField> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandInputRecordField>(MODEL$, SCHEMA$, resolver);
  }
