...
public class CommandInputRecordSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<CommandInputRecordSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CommandInputRecordSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandInputRecordSchema>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this CommandInputRecordSchema to a ByteBuffer.
  ...
  /**
   * Deserializes a CommandInputRecordSchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CommandInputRecordSchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CommandInputRecordSchema fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

  /** Defines the fields of the record. */
   private java.util.List<io.cwl.avro.CommandInputRecordField> fields;
  /** Must be `record` */
   ...
   */
  public CommandInputRecordSchema(java.util.List<io.cwl.avro.CommandInputRecordField> fields, io.cwl.avro.RecordSchemaPackage.type.Record_symbol type, java.lang.CharSequence label, java.lang.CharSequence name) {
    this.fields = fields;
    this.type = type;
    this.label = label;
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: fields = (java.util.List<io.cwl.avro.CommandInputRecordField>)value$; break;
   ...
   */
  public java.util.List<io.cwl.avro.CommandInputRecordField> getFields() {
    return fields;
  }
   ...
   */
  public void setFields(java.util.List<io.cwl.avro.CommandInputRecordField> value) {
    this.fields = value;
  }
   ...
   * @return A new CommandInputRecordSchema RecordBuilder
   */
  public static io.cwl.avro.CommandInputRecordSchema.Builder newBuilder() {
    return new io.cwl.avro.CommandInputRecordSchema.Builder();
  }
   ...
   * @return A new CommandInputRecordSchema RecordBuilder
   */
  public static io.cwl.avro.CommandInputRecordSchema.Builder newBuilder(io.cwl.avro.CommandInputRecordSchema.Builder other) {
    if (other == null) {
      return new io.cwl.avro.CommandInputRecordSchema.Builder();
    } else {
      return new io.cwl.avro.CommandInputRecordSchema.Builder(other);
    }
  }
   ...
   * @return A new CommandInputRecordSchema RecordBuilder
   */
  public static io.cwl.avro.CommandInputRecordSchema.Builder newBuilder(io.cwl.avro.CommandInputRecordSchema other) {
    if (other == null) {
      return new io.cwl.avro.CommandInputRecordSchema.Builder();
    } else {
      return new io.cwl.avro.CommandInputRecordSchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommandInputRecordSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.CommandInputRecordSchema.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.CommandInputRecordSchema other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.fields)) {
        this.fields = data().deepCopy(fields()[0].schema(), other.fields);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder setFields(java.util.List<io.cwl.avro.CommandInputRecordField> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder clearFields() {
      fields = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder setType(io.cwl.avro.RecordSchemaPackage.type.Record_symbol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder clearLabel() {
      label = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.CommandInputRecordSchema.Builder clearName() {
      name = null;
    ...
    public CommandInputRecordSchema build() {
      try {
        ...
        record.fields = fieldSetFlags()[0] ? this.fields : (java.util.List<io.cwl.avro.CommandInputRecordField>) defaultValue(fields()[0]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CommandInputRecordSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<CommandInputRecordSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CommandInputRecordSchema>
    READER$ = (org.apache.avro.io.DatumReader<CommandInputRecordSchema>)MODEL$.createDatumReader(SCHEMA$);
