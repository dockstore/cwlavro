...
public class CommandInputArraySchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CommandInputArraySchema> ENCODER =
      new BinaryMessageEncoder<CommandInputArraySchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CommandInputArraySchema> DECODER =
      new BinaryMessageDecoder<CommandInputArraySchema>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<CommandInputArraySchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandInputArraySchema>(MODEL$, SCHEMA$, resolver);
  }
