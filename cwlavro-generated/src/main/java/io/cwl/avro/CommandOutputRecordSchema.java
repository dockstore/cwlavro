...
public class CommandOutputRecordSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CommandOutputRecordSchema> ENCODER =
      new BinaryMessageEncoder<CommandOutputRecordSchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CommandOutputRecordSchema> DECODER =
      new BinaryMessageDecoder<CommandOutputRecordSchema>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<CommandOutputRecordSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommandOutputRecordSchema>(MODEL$, SCHEMA$, resolver);
  }
