...
public class ExpressionToolOutputParameter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ExpressionToolOutputParameter> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ExpressionToolOutputParameter> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ExpressionToolOutputParameter>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ExpressionToolOutputParameter to a ByteBuffer.
  ...
  /**
   * Deserializes a ExpressionToolOutputParameter from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ExpressionToolOutputParameter instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ExpressionToolOutputParameter fromByteBuffer(
...
the output parameter.
   ...
   */
  public ExpressionToolOutputParameter(java.lang.CharSequence label, java.lang.Object secondaryFiles, java.lang.Boolean streamable, java.lang.Object doc, java.lang.CharSequence id, io.cwl.avro.CommandOutputBinding outputBinding, java.lang.Object format, java.lang.Object type) {
    this.label = label;
...
the output parameter.
  ...
  /**
   * Creates a new ExpressionToolOutputParameter RecordBuilder.
   * @return A new ExpressionToolOutputParameter RecordBuilder
   */
  public static io.cwl.avro.ExpressionToolOutputParameter.Builder newBuilder() {
    return new io.cwl.avro.ExpressionToolOutputParameter.Builder();
  }

  /**
   * Creates a new ExpressionToolOutputParameter RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ExpressionToolOutputParameter RecordBuilder
   */
  public static io.cwl.avro.ExpressionToolOutputParameter.Builder newBuilder(io.cwl.avro.ExpressionToolOutputParameter.Builder other) {
    if (other == null) {
      return new io.cwl.avro.ExpressionToolOutputParameter.Builder();
    } else {
      return new io.cwl.avro.ExpressionToolOutputParameter.Builder(other);
    }
  }

  /**
   * Creates a new ExpressionToolOutputParameter RecordBuilder by copying an existing ExpressionToolOutputParameter instance.
   * @param other The existing instance to copy.
   * @return A new ExpressionToolOutputParameter RecordBuilder
   */
  public static io.cwl.avro.ExpressionToolOutputParameter.Builder newBuilder(io.cwl.avro.ExpressionToolOutputParameter other) {
    if (other == null) {
      return new io.cwl.avro.ExpressionToolOutputParameter.Builder();
    } else {
      return new io.cwl.avro.ExpressionToolOutputParameter.Builder(other);
  ...
  /**
   * RecordBuilder for ExpressionToolOutputParameter instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExpressionToolOutputParameter>
    implements org.apache.avro.data.RecordBuilder<ExpressionToolOutputParameter> {
 ...
 */
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.ExpressionToolOutputParameter.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ExpressionToolOutputParameter instance
     * @param other The existing instance to copy.
     */
    private Builder(io.cwl.avro.ExpressionToolOutputParameter other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.label)) {
        this.label = data().deepCopy(fields()[0].schema(), other.label);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setLabel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearLabel() {
      label = null;
...
of the primary file to yield a filename relative to the primary File:
  ...
  2. Append the remainder of the string to the end of the file path.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setSecondaryFiles(java.lang.Object value) {
...
of the primary file to yield a filename relative to the primary File:
  ...
  2. Append the remainder of the string to the end of the file path.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearSecondaryFiles() {
      secondaryFiles = null;
...
pipe.  Default: `false`.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setStreamable(java.lang.Boolean value) {
...
pipe.  Default: `false`.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearStreamable() {
      streamable = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setDoc(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearDoc() {
      doc = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setOutputBinding(io.cwl.avro.CommandOutputBinding value) {
    ...
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setOutputBindingBuilder(io.cwl.avro.CommandOutputBinding.Builder value) {
      clearOutputBinding();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearOutputBinding() {
      outputBinding = null;
...
the output parameter.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setFormat(java.lang.Object value) {
...
the output parameter.
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearFormat() {
      format = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder setType(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.ExpressionToolOutputParameter.Builder clearType() {
      type = null;
    ...
    public ExpressionToolOutputParameter build() {
      try {
        ExpressionToolOutputParameter record = new ExpressionToolOutputParameter();
        ...
        record.type = fieldSetFlags()[7] ? this.type :  defaultValue(fields()[7]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ExpressionToolOutputParameter>
    WRITER$ = (org.apache.avro.io.DatumWriter<ExpressionToolOutputParameter>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ExpressionToolOutputParameter>
    READER$ = (org.apache.avro.io.DatumReader<ExpressionToolOutputParameter>)MODEL$.createDatumReader(SCHEMA$);
