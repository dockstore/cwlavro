...
public class RecordSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<RecordSchema> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<RecordSchema> getDecoder() {
    return DECODER;
  }
  ...
  /**
   * Serializes this RecordSchema to a ByteBuffer.
  ...
  /**
   * Deserializes a RecordSchema from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a RecordSchema instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static RecordSchema fromByteBuffer(
      java.nio.ByteBuffer b) throws java.io.IOException {
    return DECODER.decode(b);
  }

  /** Defines the fields of the record. */
  public java.util.List<io.cwl.avro.RecordField> fields;
  /** Must be `record` */
   ...
   */
  public RecordSchema(java.util.List<io.cwl.avro.RecordField> fields, io.cwl.avro.RecordSchemaPackage.type.Record_symbol type) {
    this.fields = fields;
    this.type = type;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: fields = (java.util.List<io.cwl.avro.RecordField>)value$; break;
   ...
   */
  public java.util.List<io.cwl.avro.RecordField> getFields() {
    return fields;
  }
   ...
   */
  public void setFields(java.util.List<io.cwl.avro.RecordField> value) {
    this.fields = value;
  }
   ...
   */
  public static io.cwl.avro.RecordSchema.Builder newBuilder() {
    return new io.cwl.avro.RecordSchema.Builder();
  }
   ...
   * @return A new RecordSchema RecordBuilder
   */
  public static io.cwl.avro.RecordSchema.Builder newBuilder(io.cwl.avro.RecordSchema.Builder other) {
    if (other == null) {
      return new io.cwl.avro.RecordSchema.Builder();
    } else {
      return new io.cwl.avro.RecordSchema.Builder(other);
    }
  }
   ...
   * @return A new RecordSchema RecordBuilder
   */
  public static io.cwl.avro.RecordSchema.Builder newBuilder(io.cwl.avro.RecordSchema other) {
    if (other == null) {
      return new io.cwl.avro.RecordSchema.Builder();
    } else {
      return new io.cwl.avro.RecordSchema.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordSchema>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.cwl.avro.RecordSchema.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.RecordSchema.Builder setFields(java.util.List<io.cwl.avro.RecordField> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.RecordSchema.Builder clearFields() {
      fields = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.RecordSchema.Builder setType(io.cwl.avro.RecordSchemaPackage.type.Record_symbol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.cwl.avro.RecordSchema.Builder clearType() {
      type = null;
    ...
    public RecordSchema build() {
      try {
        ...
        record.fields = fieldSetFlags()[0] ? this.fields : (java.util.List<io.cwl.avro.RecordField>) defaultValue(fields()[0]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<RecordSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<RecordSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<RecordSchema>
    READER$ = (org.apache.avro.io.DatumReader<RecordSchema>)MODEL$.createDatumReader(SCHEMA$);
