...
public class WorkflowStep extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<WorkflowStep> ENCODER =
      new BinaryMessageEncoder<WorkflowStep>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<WorkflowStep> DECODER =
      new BinaryMessageDecoder<WorkflowStep>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<WorkflowStep> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<WorkflowStep>(MODEL$, SCHEMA$, resolver);
  }
